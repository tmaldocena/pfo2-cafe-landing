...
// These are minimal custom SVG icons matching lucide's stroke style
// (24x24 viewBox, stroke="currentColor", strokeWidth 2, round caps/joins)
// so they sit visually consistent with the rest of the icon set.
...
export function DribbbleIcon({ size = 18, className = "" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M8.56 2.75c4.37 6.03 6.02 9.42 8.03 17.72M2.34 9.5a54.43 54.43 0 0 0 16.78-1.5M2.5 16.5a45 45 0 0 1 18.07-1.46" />
    </svg>
  );
}
